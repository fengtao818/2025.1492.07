...
namespace RoOvernightTrainLogistics
{
    ...
    class Data
    {
        ...
        public bool paretoCutStrategy = true;//true--using, false-unusing --STG2-- for branch and benders cuts        
        public bool stablilization_at_rootnode = true;//using stabilized strategy at root node--STG4--
                                                     
        public bool localBranchStrategy = true;//true--using, false-unusing --STG3-- for single level subproblem
        ...
        public bool Capacitystrategy = false;
    ...
    class Program
    {
        ...
        public static void g_RoMaxFacilityLocation_optimization()
        {
            ...
            g_pFileOutputLog.WriteLine("cplexparaset, solvingprimalsub, nogoodcuts,BACforworstscenario,Capacitystrategy,MultiplescenariosforCCG");
            g_pFileOutputLog.WriteLine($"{dt.cplex_para_set}, {dt.solvingPrimalSub}, {dt.nogoodcuts},{dt.BACforworstscenario},{dt.Capacitystrategy},{dt.MultiplescenariosforCCG}");
