...
namespace RoOvernightTrainLogistics
{
    ...
    internal class BendersLazyConsCallback : Cplex.LazyConstraintCallback
    {
        ...
        public override void Main()
        {
            ...
            else
            {
                ...
                ILinearNumExpr consExpr = Bendmaster.model.LinearNumExpr();
                for (int j = 0; j < data.DCSize; j++)
                {
                    int corCommunityNode = Program.g_DCent_list[j].CorNodeSeqNo;
                    double totalsupply = 0/*data.h_i[corCommunityNode]*/;
                    ...
                    consExpr.AddTerm((1 - worst_u_j[j]) * totalsupply, Bendmaster.y_j[j]);
                }
                ...
                Add(Bendmaster.model.Ge(consExpr, alldemand));
    ...
    class CACGBD
    {
        ...
        public BendersMaster BranchandCut()
        {
            ...
            {
                Program.Solvinglog.WriteLine("out of memory error occurs:" + e.Message);
