...
namespace RoOvernightTrainLogistics
{
    ...
    class Data
    {
        ...
        public bool paretoCutStrategy = false;//true--using, false-unusing --STG2-- 
        public bool localBranchStrategy = false;//true--using, false-unusing --STG3-- 
        public bool stablilization_at_rootnode = false;//using stabilized strategy at root node--STG4--            
        public bool masterlocalbranch = true;
        public bool masterlocalbranchstrategy = false;
        public bool sublocalbranch = false;
        ...
        public bool LshapedStrategy = false;//true--using, false-unusing --STG5--   
    ...
    class Program
    {
        ...
        public static void g_RoMaxFacilityLocation_optimization()
        {
            ...
            if (CGBD_debug_flag == 1)
            {
                ...
                //solution.write_solution(Bendersmaster); solution.outputSubproSolution(Bendersmaster);
            ...
            g_pFileOutputLog.WriteLine("STG1-multicuts, STG2-Paretocut, STG3-Localbranch,STG4-Stabilization,STG5-Lshaped");
            g_pFileOutputLog.WriteLine($"{dt.multiCutStrategy}, {dt.paretoCutStrategy}, {dt.localBranchStrategy},{dt.stablilization_at_rootnode}," +
                $"{dt.LshapedStrategy}");

            g_pFileOutputLog.WriteLine("cplexparaset, solvingprimalsub, nogoodcuts,BACforworstscenario");
            g_pFileOutputLog.WriteLine($"{dt.cplex_para_set}, {dt.solvingPrimalSub}, {dt.nogoodcuts},{dt.BACforworstscenario}");
